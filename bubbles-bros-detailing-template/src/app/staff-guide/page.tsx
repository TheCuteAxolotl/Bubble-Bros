...
const sections: StaffGuideSection[] = [
  ...
  },
  {
    id: "professionalism",
    eyebrow: "02 · Brand",
    title: "Bubbles & Bros. Professionalism Guide",
  ...
  },
  {
    ...
    scripts: [
      ...
      { label: "Closing reply", text: "You’re all set — [briefly state what was done]. If anything changes, reply here and we can pick the conversation back up. — [Your Name], Bubbles & Bros." },
    ],
  },
  {
    id: "calls",
    eyebrow: "04 · Phone",
    title: "Voice Calls",
    summary: "Answer quickly, identify yourself and Bubbles & Bros., then let the customer tell you what they need.",
    points: [
    ...
    scripts: [
      { label: "Answer", text: "Hi, this is [Your Name] from Bubbles & Bros. How can I help you today?" },
      ...
      { label: "End the call", text: "Perfect, I have [next step] noted. You’ll receive the update through [text/booking chat/quote chat]. Thanks for calling Bubbles & Bros." },
    ],
  },
  {
    id: "quotes",
    ...
    scripts: [
      { label: "Opening", text: "Hi [Customer Name], [Your Name] from Bubbles & Bros. here. I’m looking over your [Vehicle] and the photos you sent now." },
  ...
  },
  {
    ...
    scripts: [
      ...
      { label: "Running late", text: "Quick update from Bubbles & Bros.: we’re running about [time] behind and now expect to arrive around [ETA]. Sorry for the delay — I wanted to let you know before your appointment time." },
      { label: "Complete", text: "Your detail is complete. Thanks for choosing Bubbles & Bros. — I’ve also added [maintenance/care note] for you." },
    ],
  },
  {
    id: "sms",
    ...
    scripts: [
      { label: "General reply", text: "Hi [Name], this is [Your Name] with Bubbles & Bros. [Direct answer]." },
      { label: "On the way", text: "Bubbles & Bros.: Your detailer is on the way and is expected to arrive around [Time]. We’ll see you soon." },
...
export default async function StaffGuidePage() {
  ...
  const visibleSections = sections.filter((section) => {
    if (section.id === "calls" && !PHONE_FEATURE_ENABLED) return false;
    if (section.id === "sms" && !SMS_FEATURE_ENABLED) return false;
    return true;
  });

  return <StaffGuideClient sections={visibleSections} isOwner={access.role === "owner"} permissions={access.permissions} />;
}
