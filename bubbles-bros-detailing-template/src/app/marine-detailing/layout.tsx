...
export const metadata: Metadata = pageMetadata({
  title: 'Mobile Marine Detailing',
  description: 'Mobile boat and marine detailing including interior cleanup, hull care, deck care, enhancement, and protection services.',
  path: "/marine-detailing",
  keywords: ['marine detailing', 'boat detailing', 'mobile boat detailing'],
});
