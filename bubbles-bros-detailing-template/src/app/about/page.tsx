...
export default async function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-white">
      <PublicHero content={content} imageCategory="about-hero" eyebrowKey="aboutEyebrow" titleKey="aboutTitle" bodyKey="aboutIntro" action={<a href="/quote" className="inline-flex rounded-full bg-[#5B8CFF] px-6 py-3.5 text-sm font-semibold text-[#0D0D0D] hover:bg-[#5B8CFF]">Get an Exact Quote</a>} />
      ...
      <section className="bg-[#FFFFFF] text-black">
        <div className="mx-auto grid max-w-[1540px] border-x border-black/10 lg:grid-cols-[1.05fr_.95fr]">
          ...
          <div className="flex flex-col justify-center border-t border-black/10 px-5 py-16 sm:px-8 lg:border-l lg:border-t-0 lg:px-12 lg:py-24">
            <p className="text-[10px] font-semibold uppercase tracking-[.28em] text-[#5B8CFF]">About</p>
      ...
      <section className="relative isolate overflow-hidden border-t border-white/10">
        ...
        <div className="mx-auto max-w-[1540px] border-x border-white/10 px-5 py-20 sm:px-8 lg:px-10">
          <p className="text-[10px] uppercase tracking-[.28em] text-[#5B8CFF]">The basics</p>
          ...
          <div className="mt-12 grid gap-px overflow-hidden rounded-[28px] border border-white/10 bg-white/10 md:grid-cols-3">
            {[
              ...
              <article key={title} className="bg-[#111318] p-7 sm:p-8">
                <p className="text-xs font-semibold text-[#5B8CFF]">0{index + 1}</p>
      ...
      <section className="bg-white text-[#0D0D0D]">
        <div className="mx-auto grid max-w-[1540px] gap-4 border-x border-black/10 px-5 py-16 sm:px-8 md:grid-cols-3 lg:px-10">
          <a href="/paint-correction" className="group rounded-[28px] border border-black/10 bg-[#F7F9FA] p-7 hover:border-[#5B8CFF]/60">
            ...
            <span className="mt-6 inline-flex text-sm font-semibold text-[#5B8CFF]">See paint correction →</span>
          </a>
          <a href="/ceramic-coatings" className="group rounded-[28px] border border-black/10 bg-[#F7F9FA] p-7 hover:border-[#5B8CFF]/60">
            ...
            <span className="mt-6 inline-flex text-sm font-semibold text-[#5B8CFF]">See ceramic coatings →</span>
          </a>
          <a href="/products-we-use" className="group rounded-[28px] border border-black/10 bg-[#F7F9FA] p-7 hover:border-[#5B8CFF]/60">
            ...
            <span className="mt-6 inline-flex text-sm font-semibold text-[#5B8CFF]">See the products we use →</span>
          </a>
        </div>
      </section>
    </div>
