...
export const metadata: Metadata = pageMetadata({
  ...
  description: 'Mobile interior detailing for seats, carpets, plastics, glass, crevices, stains, pet hair, and deeper cabin cleanup.',
  path: "/interior-detailing",
  keywords: ['interior car detailing', 'mobile interior detailing', 'car interior cleaning'],
});
