...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    response.say(
      { voice: "alice" },
      "Thanks for calling Bubbles & Bros. We are unable to answer right now. Please leave your name, your vehicle, and the service you are interested in after the beep. Press pound when you are finished."
    );
    response.record({
