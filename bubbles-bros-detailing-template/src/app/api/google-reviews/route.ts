...
const GOOGLE_REVIEW_URL = process.env.NEXT_PUBLIC_GOOGLE_REVIEW_URL?.trim() || process.env.NEXT_PUBLIC_GOOGLE_BUSINESS_URL?.trim() || "";
...
export async function GET() {
  ...
  try {
    ...
    return NextResponse.json(
      {
        businessName: place.displayName?.text ?? process.env.NEXT_PUBLIC_BUSINESS_NAME ?? "Bubbles & Bros.",
