    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <header className="border-b border-neutral-800 bg-neutral-950">
        <div className="mx-auto max-w-7xl px-6 py-6 flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg bg-[#5B8CFF] text-[#0D0D0D] hover:bg-[#5B8CFF] transition text-sm font-medium"
          >
            Logout
          </button>
        </div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <a href="/staff-guide">
            <div className="rounded-3xl border border-neutral-800 bg-neutral-950 p-8 hover:border-[#5B8CFF]/45 transition cursor-pointer">
              <div className="rounded-2xl bg-[#5B8CFF]/10 p-4 w-12 h-12 flex items-center justify-center mb-4"><span className="text-2xl">◎</span></div>
              <h2 className="text-xl font-semibold mb-2">Staff Guide</h2>
              <p className="text-neutral-400 text-sm">Rules, professionalism standards, support scripts, quote chat, booking chat, and customer communication guidance</p>
            </div>
          </a>
          <a href="/owner/website">
            <div className="rounded-3xl border border-neutral-800 bg-neutral-950 p-8 hover:border-[#5B8CFF]/45 transition cursor-pointer">
              <div className="rounded-2xl bg-[#5B8CFF]/10 p-4 w-12 h-12 flex items-center justify-center mb-4">
          ...
          <a href="/owner/booking-settings">
            <div className="rounded-3xl border border-neutral-800 bg-neutral-950 p-8 hover:border-[#5B8CFF]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-400 text-sm">Set available days and times, block off dates, and manage booking add-ons and discount codes</p>
            </div>
          </a>
...
<>
          <a href="/owner/messages">
            <div className="relative rounded-3xl border border-neutral-800 bg-neutral-950 p-8 hover:border-[#5B8CFF]/45 transition cursor-pointer">
              {smsUnread > 0 && (
                <span className="absolute right-5 top-5 rounded-full bg-[#5B8CFF] px-2.5 py-1 text-xs font-bold text-[#0D0D0D]">
                  {smsUnread}
                </span>
              )}
              <div className="rounded-2xl bg-[#5B8CFF]/10 p-4 w-12 h-12 flex items-center justify-center mb-4">
...
<>
          ...
          <a href="/owner/calls">
            <div className="rounded-3xl border border-neutral-800 bg-neutral-950 p-8 hover:border-[#5B8CFF]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-400 text-sm">Forward Bubbles & Bros. calls to your phone, review call history, and block unwanted callers</p>
            </div>
          </a>
          ...
          <a href="/owner/warranties">
            <div className="rounded-3xl border border-neutral-800 bg-neutral-950 p-8 hover:border-[#5B8CFF]/45 transition cursor-pointer">
              <div className="rounded-2xl bg-[#5B8CFF]/10 p-4 w-12 h-12 flex items-center justify-center mb-4"><span className="text-2xl">🛡️</span></div>
