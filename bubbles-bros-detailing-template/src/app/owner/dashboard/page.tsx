...
export default function OwnerDashboard() {
  ...
  useEffect(() => {
    if (!user || !SMS_FEATURE_ENABLED) return;
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <a href="/staff-guide">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Rules, professionalism standards, support scripts, quote chat, booking chat, and customer communication guidance</p>
            </div>
          </a>
          <a href="/owner/website">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              <div className="rounded-2xl bg-[#000B3D]/10 p-4 w-12 h-12 flex items-center justify-center mb-4">
                <span className="text-2xl">✦</span>
              </div>
              <h2 className="text-xl font-semibold mb-2">Website Editor</h2>
              <p className="text-neutral-600 text-sm">Edit homepage, FAQ, About, page copy, and public site wording</p>
            </div>
          </a>
          <a href="/owner/pricing-pages">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Customize Car Packages, Exterior, and Interior fixed pricing pages</p>
            </div>
          </a>
          ...
          <a href="/owner/booking-settings">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Set available days and times, block off dates, and manage booking add-ons and discount codes</p>
            </div>
          </a>
          ...
          <a href="/owner/services">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Edit service descriptions and prices</p>
            </div>
          </a>
          ...
          <a href="/owner/gallery">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Upload photos with clear page and section labels so you always know where they appear</p>
            </div>
          </a>
          ...
          <a href="/owner/bookings">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">View and manage customer bookings</p>
            </div>
          </a>
...
<>
          <a href="/owner/messages">
            <div className="relative rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">See customer text replies and open the booking conversation to text back</p>
            </div>
          </a>
</>
          )}
...
<>
          ...
          <a href="/owner/calls">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Forward Bubbles & Bros. calls to your phone, review call history, and block unwanted callers</p>
            </div>
          </a>
          ...
          <a href="/owner/analytics">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Bookings, leads, customers, and accepted quote value</p>
            </div>
          </a>
          ...
          <a href="/owner/support">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Reply to website support chats and block repeat spam</p>
            </div>
          </a>
          ...
          <a href="/owner/admins">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Manage customers, Admin access, custom roles, dashboard permissions, and account information</p>
            </div>
          </a>
          ...
          <a href="/owner/settings">
            <div className="rounded-3xl border border-[#000B3D]/10 bg-white p-8 hover:border-[#000B3D]/45 transition cursor-pointer">
              ...
              <p className="text-neutral-600 text-sm">Update your account and preferences</p>
            </div>
          </a>
        </div>
      </main>
