...
export const metadata: Metadata = pageMetadata({
  ...
  description: 'Terms and Conditions for Bubbles & Bros. quotes, bookings, vehicle condition, results, payments, and website accounts.',
        ...
        <div className="mt-10 space-y-10 text-[15px] leading-7 text-black/70">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              Bubbles & Bros. is not responsible for ordinary wear, pre-existing damage, defects, or problems that could not
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              quote, booking, or support chat to harass, spam, or abuse Bubbles & Bros. or other users.
            </p>
          </section>
