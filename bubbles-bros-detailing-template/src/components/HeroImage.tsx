...
export default function HeroImage() {
  ...
  return (
    <div className="relative">
      <div className="absolute -inset-5 -z-10 rounded-[3rem] bg-[#5B8CFF]/10 blur-3xl" />
      <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[#111318] shadow-[0_30px_100px_rgba(0,0,0,.55)]">
        {image ? (
          <div className="relative">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 sm:p-7">
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-[#5B8CFF]">Featured Work</p>
              <div className="mt-2 flex items-end justify-between gap-5">
                <h2 className="max-w-md text-xl font-black sm:text-2xl">{image.title}</h2>
                <span className="shrink-0 rounded-full border border-white/15 bg-black/40 px-3 py-2 text-[10px] font-black uppercase tracking-[0.2em] text-white backdrop-blur">Bubbles & Bros.</span>
              </div>
            </div>
          </div>
        ) : (
          <div className="relative flex h-[430px] items-end overflow-hidden p-7 sm:h-[510px]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_25%,rgba(255,45,45,.20),transparent_38%),linear-gradient(145deg,#171717,#080808)]" />
            <div className="absolute inset-7 rounded-[1.4rem] border border-white/10" />
            <div className="relative">
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-[#5B8CFF]">Homepage Hero</p>
