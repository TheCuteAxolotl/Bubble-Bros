    ...
    <section className="border-t border-white/8 bg-[#0a0a0a] px-5 py-14 text-white sm:px-8 lg:py-20">
      <div className="mx-auto max-w-[1180px]">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[.26em] text-[#5B8CFF]">Related services</p>
            <h2 className="mt-3 text-3xl font-semibold tracking-[-.04em] sm:text-4xl">Not sure which service fits your vehicle?</h2>
          </div>
          <a href="/quote" className="inline-flex w-fit rounded-full bg-[#5B8CFF] px-5 py-3 text-sm font-semibold text-[#0D0D0D]">Get an Exact Quote</a>
        </div>
          ...
          {visible.map((service) => (
            <a key={service.href} href={service.href} className="group rounded-[22px] border border-white/10 bg-white/[.025] p-5 transition hover:border-white/20 hover:bg-white/[.045]">
              <div className="flex items-center justify-between gap-4">
                ...
                <span className="text-white/25 transition group-hover:translate-x-1 group-hover:text-[#5B8CFF]">→</span>
              </div>
